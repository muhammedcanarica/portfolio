const technologies = ["C#", ".NET", "Python", "OpenCV", "Unity", "SQLite", "React", "Git"];
...
export const content = {
  tr: {
    ...
    nav: [
      ...
      { href: "#skills", label: "Teknolojiler" },
    ...
    hero: {
      ...
      description: "Bilgisayar Mühendisliği öğrencisiyim. Şu sıralar C#, .NET, Python ve Unity ile çalışıyorum.",
      location: "Türkiye",
      edition: "Kişisel portfolyo",
      work: "Seçilmiş çalışmalar",
    },
    projects: {
      eyebrow: "01 / Seçilmiş çalışmalar",
      title: "Fikirden uygulamaya.",
      note: "Ağ araçları, görüntü işleme ve oynanabilir dünyalar. Üzerinde çalıştığım altı proje.",
      stackLabel: "Kullanılan teknolojiler",
      imageLabel: "Proje görüntüsü",
    },
    about: {
      eyebrow: "02 / Hakkımda",
    ...
    skills: {
      eyebrow: "03 / Teknolojiler",
      title: "Araç kutum.",
      items: technologies,
    },
    contact: {
      eyebrow: "04 / İletişim",
      title: "Bir merhaba ile başlayalım.",
      description: "Bir proje, staj fırsatı ya da paylaşmak istediğin bir fikir için yazabilirsin.",
      links: { email: "E-posta", github: "GitHub", cv: "CV'yi aç" },
      backToTop: "Başa dön",
      credit: "Can Arıca",
    },
  },
  en: {
    ...
    hero: {
      ...
      description: "Computer Engineering student. Currently working with C#, .NET, Python and Unity.",
      location: "Based in Türkiye",
      edition: "Personal portfolio",
      work: "Selected work",
    },
    projects: {
      eyebrow: "01 / Selected work",
      title: "From idea to application.",
      note: "Network tools, computer vision and playable worlds. Six projects I've been working on.",
